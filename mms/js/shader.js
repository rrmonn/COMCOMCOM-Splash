...
const imgSize = [document.querySelector(".thumb_1").clientWidth, document.querySelector(".thumb_1").clientHeight];
...
const fragment = `
    ...
    const canvas = document.querySelector(".thumb_1").appendChild(gl.canvas);
    ...
    img.src = "https://uploads-ssl.webflow.com/5ea187296c26ca00cd8318c4/5eaa3773f27a1561ad9f71cf_1.The-Iconic-thumb-2.png?";
